...
public class parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\003\000\002\003\011\000\002\004\007\000\002\013\003" +
    ...
    "\003\000\002\020\005\000\002\007\006\000\002\012\003" +
    "\000\002\012\005\000\002\010\002\000\002\010\005\000" +
    "\002\011\005\000\002\011\005\000\002\011\005\000\002" +
    "\011\004\000\002\011\005" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\063\000\010\002\003\003\006\007\004\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\004\012\011\001\001\000" +
    ...
    "\000\002\001\001\000\004\011\033\001\001\000\004\011" +
    "\032\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\004\004\043" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\006\005\051\013\050\001\001\000\006\005\051" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
          ...
          case 30: // consulta_sqlkv ::= SELECCIONAR REPORTE lista_id_trivias filtro 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("consulta_sqlkv",5, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("lista_id_trivias",8, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String id = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("lista_id_trivias",8, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 33: // filtro ::= 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("filtro",6, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 34: // filtro ::= FILTRAR POR condicion 
            {
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("filtro",6, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
